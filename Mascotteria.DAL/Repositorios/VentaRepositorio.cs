...
namespace Mascotteria.DAL.Repositorios
{
    public class VentaRepositorio : GenericRepository<Venta>, IVentaRepository
    {
        private readonly DbmascotteriaContext _dbcontext;

        public VentaRepositorio(DbmascotteriaContext dbcontext) : base(dbcontext)
        {
